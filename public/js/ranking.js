  ...
  async _load() {
    ...
    try {
      ...
      var html =
        ...
        + '<div style="background:rgba(104,211,145,0.1);border-radius:10px;padding:10px"><div style="font-size:26px;font-weight:800;color:#68d391">+' + ganho + '</div><div style="font-size:10px;color:#a0aec0">' + this._periodo + '</div></div>'
